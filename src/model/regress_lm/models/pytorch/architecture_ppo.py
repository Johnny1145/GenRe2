...
class CustomEncoderDecoder(nn.Module):
    ...
    def forward(
        ...
        return self.generator(decoder_output), self.critic(decoder_output)
    ...
    def next_token_logits(
        ...
        return self.generator(decoder_output_all_steps[:, -1, :]), self.critic(decoder_output_all_steps[:, -1, :])
