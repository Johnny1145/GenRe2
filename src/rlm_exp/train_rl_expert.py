...
from src.utils.ReMax_rlm_expert import Remax
...
class HFRegressionModule(torch.nn.Module):
    def __init__(self, cfg: DictConfig, y_quantile_transformer: Optional[Any] = None):
        ...
        self.remax = Remax(
            ...
            expert_ce_weight=float(getattr(cfg, "expert_ce_weight", 0.1)),
...
def main(cfg: DictConfig):
    ...
    base_results_dir = Path("results_exp_rlm/results_exp_rlm_remax_expert_new")
