...
def get_args():
    ...
    parser.add_argument("--num_gpus", type=int, default=8, help="number of gpus to use, for multi-node vllm")
    parser.add_argument("--vllm_gpu_util", type=float, default=0.5, help="gpu utilization for vllm")
...
def main():
    ...
    if not is_api_models:
        ...
        if "gemma" in args.model.lower() and not tokenizer.chat_template:
