...
def main(cfg: DictConfig):
    ...
    results_dir = Path(f"results_search_mlp_encoder_ntl_mse/{dataset_name}")
    results_dir.mkdir(parents=True, exist_ok=True)
    # results.json
    if cfg.skip_mode:
        results_json_path =Path(f"results_search_mlp_encoder_ntl_mse/{dataset_name}/{dataset_name}/results_seed_{cfg.seed}.json")
